...
BetHistoryResponse betHistoryResponseFromMap(String str) => BetHistoryResponse.fromMap(json.decode(str));

String betHistoryResponseToMap(BetHistoryResponse data) => json.encode(data.toMap());
...
class BetHistoryResponse {
    ...
    factory BetHistoryResponse.fromMap(Map<String, dynamic> json) => BetHistoryResponse(
...
class PlacedBets {
    ...
    factory PlacedBets.fromMap(Map<String, dynamic> json) => PlacedBets(
        ...
        bets: json["bets"] == null ? null : List<Bet>.from(json["bets"].map((x) => Bet.fromMap(x))),
    ...
    Map<String, dynamic> toMap() => {
        ...
        "bets": bets == null ? null : List<dynamic>.from(bets!.map((x) => x.toMap())),
