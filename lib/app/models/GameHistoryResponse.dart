...
GameHistoryResponse gameHistoryResponseFromMap(String str) =>
    GameHistoryResponse.fromMap(json.decode(str));

String gameHistoryResponseToMap(GameHistoryResponse data) =>
...
class GameHistoryResponse {
  ...
  factory GameHistoryResponse.fromMap(Map<String, dynamic> json) =>
      GameHistoryResponse(
        gameHistory: json["gameHistory"] == null
            ? null
            : GameHistory.fromMap(json["gameHistory"]),
